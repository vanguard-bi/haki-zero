...
export const initialMessages: Message[] = [
  {
    ...
    id: "0",
    content:
      "Hi! I am your research assistant. I am happy to help with your questions about Kenyan law.",
  },
];
...
export const getSources = (data: JSONValue | null, role: string, index: number) => {
  if (data === null) {
    console.log("Data parameter is null");
    return [];
  }
